...
import { classifyEmbedPx, EMBED } from "./model.js?v=w0d";
import { SAMPLE_MEDIA } from "./assets.js?v=w0d";
import { el, css } from "./render.js?v=w0d";
import { buildIframe } from "./embeds.js?v=w0d";
